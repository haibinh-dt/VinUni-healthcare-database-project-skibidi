...
-- =====================================================
-- TABLE 1: DEPARTMENT (8 departments)
-- =====================================================
...
-- =====================================================
-- TABLE 5: MEDICALSERVICE (15 services)
-- =====================================================
...
-- =====================================================
-- TABLE 7: SUPPLIER (6 pharmaceutical suppliers)
-- =====================================================
...
-- =====================================================
-- TABLE 8: NOTIFICATION_TYPE (7 types)
-- =====================================================
...
-- =====================================================
-- TABLE 9: DEPARTMENT_LEADERSHIP (5 leadership records)
-- =====================================================
INSERT INTO Department_Leadership (department_id, doctor_id, start_date, end_date) VALUES
(1, 1, '2023-01-01', NULL),                    -- Dr. Nguyen Van Minh - Current Head of Internal Medicine
(2, 2, '2022-06-01', NULL),                    -- Dr. Tran Thi Lan - Current Head of Surgery
...
-- =====================================================
-- TABLE 10: PHARMACYITEM (25 items)
-- =====================================================
...
SELECT 'Department' AS TableName, COUNT(*) AS RowCount FROM Department
UNION ALL
...
UNION ALL
SELECT 'MedicalService', COUNT(*) FROM MedicalService
UNION ALL
